...
const labelForm = document.querySelectorAll('.input-label');

inputForm.forEach(function(el, index) {
    el.addEventListener('focus', () => {
        labelForm[index].classList.add('label-active');
    })
    el.addEventListener('blur', () => {
        if(el.value === '') {
            labelForm[index].classList.remove('label-active');
        }
    })
});
